...
const vacancies: Vacancy[] = [
  {
    ...
    conditions: [
      "Зарплата от 80 000 руб. — без задержек, на карту",
  ...
  },
  {
    ...
    conditions: [
      "Зарплата от 75 000 руб. — стабильная, без задержек",
  ...
  },
  {
    ...
    conditions: [
      "Зарплата от 75 000 руб. — своевременно",
      "Официальное трудоустройство по ТК РФ",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Ручная дуговая сварка (РДС) — обязательно",
      "Полуавтоматическая сварка (MIG/MAG) — желательно",
      "Квалификационное удостоверение сварщика",
    ...
    conditions: [
      "Зарплата от 85 000 руб. — одна из лучших в отрасли",
      "Официальное трудоустройство",
